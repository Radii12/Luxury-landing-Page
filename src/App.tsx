  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-[#C9A227] selection:text-black">
      ...
      <main>
        ...
        <HeroSection lang={lang} onOpenBookingModal={handleOpenBookingModal} />

        {/* Section 3: Services Grid */}
        <ServicesGrid lang={lang} onSelectService={handleOpenBookingModal} />

        {/* Section 4: Why Choose Us / Differentiation */}
        <WhyChooseUs lang={lang} />

        {/* Section 5: Fleet Showcase */}
        <FleetShowcase lang={lang} onSelectVehicle={handleSelectVehicleClass} />
        ...
        <CoverageMap
          lang={lang}
          onSelectHubRoute={(hubName) =>
            handleOpenWithRoute(`Hub Pickup Request: ${hubName}`)
          }
        />
        <Price lang={lang} onOpenBookingModal={handleOpenBookingModal} />
