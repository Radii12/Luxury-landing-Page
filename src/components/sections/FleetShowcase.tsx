              ...
              >
                ...
                <div className="bg-[#0a0a0a] border border-[#C9A227]/10 flex items-center overflow-hidden transition-all duration-300 shadow-[0_-8px_16px_rgba(201,162,39,0.12)]">
                  ...
                  <div className="w-[30%] h-[160px] p-3">
                    <img src={car.imageJpg} alt={car.name} className="w-full h-full object-cover grayscale-[0.3]" />
                  </div>
                  ...
                  <div className="w-[70%] p-3 flex flex-col justify-center">
                    ...
                    <div>
                      <div className="flex justify-between items-start mb-1">
                        ...
                        <span className="text-[8px] uppercase tracking-widest text-[#C9A227]/70 font-bold border border-[#C9A227]/10 px-2 py-0.5">
                          {car.classType[lang]}
                        </span>
                      </div>
                      {/* الوصف: سطرين */}
                      <p className="text-[10px] text-white/50 leading-tight line-clamp-2 italic pr-4">
                    ...
                    <div className="mt-4 flex justify-between items-center">
                       <div className="flex gap-4">
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-[10px] text-white/70 font-bold">{car.passengers}</span>
                          </div>
                          <div className="flex items-center gap-1.5">
                            <Briefcase className="w-3.5 h-3.5 text-[#C9A227]/70" />
                            <span className="text-[10px] text-white/70 font-bold">{car.luggage}</span>
                          </div>
                       </div>
